...
@section('section')
		...
		@section ('dpanel_panel_body')
			...
			@endsection
			@include('MS::widgets.panel', array('header'=>true, 'as'=>'inside'))
		@endsection	
...
<i class="fa fa-at"></i>include('MS::widgets.collapse', array('id'=>'2', 'header'=> 'This is a header', 'body'=>'Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo.'))
		...
		@section ('dbutton_panel_body')
			@include('MS::widgets.button', array('value'=>'Info button', 'class'=>'info'))
			@include('MS::widgets.button', array('class'=>'danger', 'size'=>'lg', 'value'=>'Large Button'))
			@include('MS::widgets.button', array('class'=>'success btn-outline', 'value'=>'Primary'))
		@endsection	
...
<i class="fa fa-at"></i>include('MS::widgets.alert', array('class'=>'info', 'dismissable'=>true, 'message'=> 'My message'))
		...
		@section ('dprogress_panel_body')
			@include('MS::widgets.progress', array('class'=> 'success', 'value'=>'44'))
			@include('MS::widgets.progress', array('animated'=> true, 'value'=>'72'))
			@include('MS::widgets.progress', array('class'=> 'danger', 'value'=>'12', 'badge'=>true))
		@endsection	
...
<i class="fa fa-at"></i>include('MS::widgets.progress', array('class'=> 'danger', 'value'=>'12', 'badge'=>true))
		...
		@endsection
		@include ('MS::widgets.panel', array('class'=>'primary', 'header'=>true, 'footer'=>true, 'as'=>'dprogress'))
